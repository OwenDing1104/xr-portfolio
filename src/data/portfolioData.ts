...
export const profile: Profile = {
  ...
  about: [
    "我是一名关注 XR、游戏交互与用户研究方法的交互开发者，目前主要使用 Unity、C#、Meta XR SDK、交互原型设计和用户研究方法来构建面向大众的沉浸式体验。我的项目经验覆盖 VR 文化遗产体验、VR 生存探索场景、泰坦尼克号空间复刻、Unity 交互系统原型，以及部分学术研究。",
    "在过去的项目中，我不仅关注系统是否能够被实现，也关注用户是否能够理解、学习和自然地使用这些沉浸式系统。因此，这个作品集重点展示三类能力：从真实问题出发设计 XR 和游戏交互体验，使用 Unity 和 XR 工具实现交互原型，并通过用户研究方法评估体验的有效性。"
  ]
};
...
const projectData: Project[] = [
  {
    ...
    summary:
      "一个面向护理学院远程课程场景的 XR 教学项目，基于 Apple Vision Pro 设计 Code Blue 抢救中的沟通与协作训练体验。",
    role: "参与交互原型开发，设计三维场景中的画笔标注功能，并支持课后复盘与流程回顾。",
    tags: [
      "Apple Vision Pro",
      "XR Teaching",
      "Medical Training",
    ...
    sections: [
      {
        title: "项目概述",
        body: [
          "该项目来自密歇根大学团队开发，面向护理学院远程课程场景，基于 Apple Vision Pro 设计 XR 教学体验。项目聚焦 Code Blue 抢救中的沟通与协作训练，希望让学生在远程教学中更直观地理解医护角色、站位关系和流程协作。"
        ]
      },
      {
        title: "项目目标",
  ...
  },
  {
    ...
    timeline: "2025.06 – 至今",
    summary:
      "一个基于 Unity 的 VR 文化遗产体验，将中国传统糖画中的手部动作、工具倾斜和绘制反馈转化为可交互的沉浸式学习体验。",
    role: "负责 VR 交互逻辑、绘制机制调试和动作到视觉反馈的映射优化。",
    tags: [
      "Unity",
      "C#",
      "VR Interaction",
  ...
  },
  {
    ...
    title: "VR作业：孤岛求生",
    subtitle: "Unity VR 生存探索场景",
    timeline: "2025.01 – 2025.05",
    summary:
      "一个基于 Unity 的 VR 课程项目，以孤岛环境中的生存探索为主题，练习空间导航、物体拾取、资源交互和环境反馈。",
    role: "负责场景搭建、基础交互逻辑、可交互物体反馈和体验流程调试。",
    tags: [
      "Unity",
      "C#",
      "VR Interaction",
    ...
    sections: [
      {
        title: "项目概述",
        body: [
          "孤岛求生是一个 VR 课程个人作业项目，场景围绕孤岛环境中的探索和生存任务展开。项目重点是通过场景设计，多个可交互物体和清晰反馈，让用户能够在 VR 中理解自己当前的位置、目标和可执行动作。"
        ]
      },
      {
        title: "项目目标",
        body: [
          "项目目标是设计 VR 场景中的孤岛体验：用户需要在孤岛环境中移动、观察、寻找资源，并通过手柄与物体互动。这个作业强调场景尺度真实性、交互提示和反馈节奏，让用户不依赖额外说明也能理解体验流程。"
        ]
      },
      {
        title: "我的职责",
      ...
      },
      {
        title: "设计与实现挑战",
        body: [
          "孤岛场景的挑战在于空间较开放，用户容易迷失方向，交互目标也容易被环境细节淹没。因此需要通过地形结构、显著物体建立清晰的可操作感。",
      ...
      },
      {
        title: "项目成果",
        body: [
          "这个作业展示了我在 Unity VR 场景组织、基础交互实现和体验流程调试方面的能力。它适合作为作品集中说明 VR 场景搭建和交互基础的项目，也为后续更复杂的沉浸式原型打下了技术基础。"
        ]
      }
    ],
    media: [
  ...
  {
    id: "vr-fire-feedback",
    title: "Unity VR 水流灭火原型",
    subtitle: "水流、火焰与环境反馈系统",
    timeline: "2026.01 – 2026.05",
    summary:
      "一个基于 Unity 的 VR 环境反馈原型，用户可以使用水流与火焰互动，系统根据命中位置生成水花、烟雾和火焰变化。",
    role: "负责粒子系统、碰撞检测、反馈逻辑和视觉效果调试。",
    tags: [
      "Unity",
      "C#",
      "Particle System",
    ...
    sections: [
      {
        title: "项目概述",
        body: [
          "该项目是一个 Unity VR 交互原型，重点探索用户动作如何触发环境中的实时反馈。此项目是一个教育科技课程最终作业中的demo部分，示例场景是用户在 VR 中使用水流或水枪对火焰进行灭火，系统根据水流与火焰的接触产生水花、烟雾和火焰变化。"
        ]
      },
      {
        title: "项目目标",
        body: [
          "此项目目标是让用户体验消防员的角色。对于灭火场景，用户需要看到自己瞄准的位置、水流接触火焰的位置，以及火焰和烟雾如何随着操作发生变化。"
        ]
      },
      {
        title: "我的职责",
  ...
  },
  {
    ...
    title: "VR作业2：泰坦尼克号复刻",
    subtitle: "Unity VR 历史空间场景复刻",
    timeline: "2025.01 – 2025.05",
    summary:
      "一个基于 Unity 的 VR 场景历史场景复刻作业，我围绕泰坦尼克号相关照片进行建模、尺度组织、灯光氛围和沉浸式漫游体验练习。",
    role: "负责场景复刻、空间比例整理、灯光与氛围调试，以及 VR 漫游体验检查。",
    tags: [
      "Unity",
      "C#",
      "VR Environment",
    ...
    sections: [
      {
        title: "项目概述",
        body: [
          "泰坦尼克号复刻是一个 Unity VR 课程作业，目标是将泰坦尼克号相关空间转化为可以在 VR 中浏览和体验的场景。项目重点放在空间比例、场景氛围、历史感表达和 VR 漫游体验上。"
        ]
      },
      {
        title: "项目目标",
      ...
      },
      {
        title: "项目成果",
        body: [
          "这个作业展示了我在 Unity VR 场景复刻、空间组织、灯光氛围和漫游体验检查方面的能力。它能够补充作品集中偏场景设计和沉浸式空间表达的一面。"
        ]
      }
    ],
    media: [
